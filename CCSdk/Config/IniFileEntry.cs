...
namespace CCSdk
{
    ...
    /// </summary>
    public sealed class IniFileEntry
    {
        /// <summary>
        /// Field CommentKeyStringFormat.
        /// </summary>
        private const string COMMENT_KEY_STRING_FORMAT = "[Key1][{0}][Key2][{1}]";
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="IniFileEntry" /> class.
        /// </summary>
        /// <param name="iniFile">Ini file name.</param>
        public IniFileEntry(string iniFile)
        {
        ...
        public void RemoveSection(string section)
        {
            ...
            try
            {
                ...
                this._comments.Remove(string.Format(COMMENT_KEY_STRING_FORMAT, section, string.Empty));
            }
            finally
            {
                this._readerWriterLock.ReleaseWriterLock();
        ...
        public void RemoveKey(string section, string key)
        {
            ...
            try
            {
                if(this.Sections.ContainsKey(section))
                {
                    ...
                    this._comments.Remove(string.Format(COMMENT_KEY_STRING_FORMAT, section, key));
                }
            }
            finally
            {
        ...
        public string GetComment(string section, string key = null, bool refresh = false)
        {
            ...
            string commentKey = string.Format(COMMENT_KEY_STRING_FORMAT, section, key ?? string.Empty);
                    ...
                    if(!string.IsNullOrEmpty(line))
                    {
                        ...
                        else
                        {
                            if(line.StartsWith("[", StringComparison.OrdinalIgnoreCase) && line.EndsWith("]", StringComparison.OrdinalIgnoreCase))
                            {
                                ...
                                this._comments[string.Format(COMMENT_KEY_STRING_FORMAT, section, string.Empty)] = comments.ToString();
                            ...
                            else if(!string.IsNullOrEmpty(section) && !line.StartsWith("=", StringComparison.OrdinalIgnoreCase) && line.Contains("="))
                            {
                                ...
                                this._comments[string.Format(COMMENT_KEY_STRING_FORMAT, section, key)] = comments.ToString();
        ...
        private void InternalSave(string filename)
        {
            ...
            try
            {
                ...
                foreach(var section in this.Sections)
                {
                    string sectionCommentKey = string.Format(COMMENT_KEY_STRING_FORMAT, section, string.Empty);
                    ...
                    {
                        string valueCommentKey = string.Format(COMMENT_KEY_STRING_FORMAT, section, key);
                        string valueComment;
