...
namespace CCSdk.Util
{
    ...
    public sealed class WebUtils
    {
        ...
        public string DoPost(string url, CDictionary textParams)
        {
        ...
        /// <returns>HTTP响应</returns>
        public string DoPost(string url, CDictionary textParams, IDictionary<string, string> headerParams)
        {
        ...
        /// <param name="textParams">请求文本参数</param>
        /// <returns>HTTP响应</returns>
        public string DoGet(string url, CDictionary textParams)
        {
        ...
        /// <param name="headerParams">请求头部参数</param>
        /// <returns>HTTP响应</returns>
        public string DoGet(string url, CDictionary textParams, IDictionary<string, string> headerParams)
        {
        ...
        /// <param name="headerParams">请求头部参数</param>
        /// <returns>HTTP响应</returns>
        public string DoPost(string url, CDictionary textParams, IDictionary<string, FileItem> fileParams, IDictionary<string, string> headerParams)
        {
            // 如果没有文件参数，则走普通POST请求
            ...
            foreach (KeyValuePair<string, object> kv in textParams)
            {
        ...
        public static string BuildRequestUrl(string url, CDictionary parameters)
        {
        ...
        public static string BuildQuery(CDictionary parameters)
        {
            if (parameters == null || parameters.Count == 0)
            {
                return null;
