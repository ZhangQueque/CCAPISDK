...
{
    public delegate object ConvertDelegate(IReader reader, Type type);
    ...
    public interface IReader
    {
        ...
        object GetReferenceObject(object name, Type type, ConvertDelegate convert);
        ...
        IList GetListObjects(string listName, string itemName, Type type, ConvertDelegate convert);
    }
}
