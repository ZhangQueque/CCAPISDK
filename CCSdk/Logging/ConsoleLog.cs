...
namespace CCSdk.Logging
{
    ...
    public class ConsoleLog : ILog
    {
        ...
        {
            m_Name = name;
            Console.SetOut(new StreamWriter(Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "logData3.log"), true));
            writer = new StreamWriter(Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "logData1.log"), true);
            //Console.SetOut(new StreamWriter(Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "logData2.log"), true));
        }
        ...
        public void Debug(object message)
        {
            ...
            {
                writer.WriteLine(m_MessageTemplate, m_Name, m_Debug, message);
